...
oj = ['cses', 'loj', 'leetcode','hackerrank','codeforces','toph']
oj_index=[1,2,3,4,5,6]
solved =[cses_sc.cses,loj_sc.loj, lc_sc.leetcode, hr_sc.total_count, cf_sc.cf, tp_sc.toph]
